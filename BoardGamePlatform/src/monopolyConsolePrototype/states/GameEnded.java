 ...
 * The Class GameEnded.
 */
public class GameEnded extends State {

	/**
	 * Instantiates a new game ended.
	 *
	 ...
	 */
	public GameEnded(Board board, Player currentPlayer,
	...
	public Context getContext() {
		return new Context("GameEnded", board, currentPlayer, allPlayers);
	}

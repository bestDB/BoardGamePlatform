 ...
 * The Class Prison.
 */
public class Prison extends State {
	 ...
	 */
	public Prison(Board board, Player currentPlayer, List<Player> allPlayers,
			StateChangable stateChangable) {
	...
	public Context getContext() {
		return new Context("Prison", board, currentPlayer, allPlayers);
	}
